...
export default function Projects() {
    ...
    return (
        <div className="page-container">
            {/* Header */}
            <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} style={{ marginBottom: '2.5rem' }}>
            ...
            >
                {filterTags.map((tag) => (
                    <button key={tag} className={`filter-btn ${activeFilter === tag ? 'active' : ''}`} onClick={() => setActiveFilter(tag)}>
                        {tag}
                    </button>
                ))}
            </motion.div>
                    ...
                    {filtered.map((project, i) => (
                        ...
                        >
                            ...
                            <div style={{ padding: '1.5rem' }}>
                                ...
                                >
                                    <h3 style={{ fontWeight: 700, fontSize: '1.05rem', lineHeight: 1.35, flex: 1 }}>{project.title}</h3>
                                    <motion.span
